...
class ZRender //: public ZRenderBase
{
  ...
  public:
	...
	virtual void enter_event_loop() {
                ...
                SDL_Rect gScreenRect = { 0, 0, 1080, 2030 };
                                   ...
                                   ///*
                                    ...
                                    /**/
                                      if ( e.type == SDL_FINGERMOTION  ) 	{
                                         //SDL_Log("x: %f , y: %f.\n", 1000*e.tfinger.x, 1000*e.tfinger.y);
                                        //SDL_Log("workd");
                                       ...
                                       // set_drawing_color(255,255,0);
                                          //SDL_Log("x: %f , y: %f.\n", last_x, last_y);
                                          //draw_point(last_y,last_x,30);
                                          check_select_active_object(last_x,last_y);
                                    ...
                                    else if(e.type == SDL_MOUSEWHEEL)
                                    {
                                            ...
                                            {
                                                        zoomout_to_point(last_x,last_y);
                                            }
                                            else if(e.wheel.y < 0) // scroll down
                                            {
                                                        zoomin_to_point(last_x,last_y);
                                            }
                                    }
